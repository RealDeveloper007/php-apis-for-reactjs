...
<!--						<label for="AMOUNT" class="col-sm-3 control-label">Amount</label>-->
						<div class="col-sm-6">
							<input type="hidden" name="AMOUNT" id="AMOUNT" class="form-control" value="100" readonly/>
						</div>
					</div>
					<div class="form-group">
...
<!--						<label for="RETURN_URL" class="col-sm-3 control-label">Return URL</label>-->
						<div class="col-sm-6">
							<input type="hidden" name="RETURN_URL" id="RETURN_URL" class="form-control" value="<?php echo $fullPath['protocol'] . $fullPath['host'] . '/' . $root . '/PayWeb3/result.php'; ?>" />
						</div>
					</div>
					<div class="form-group">
...
<!--						<label for="EMAIL" class="col-sm-3 control-label">Customer Email</label>-->
						<div class="col-sm-6">
							<input type="hidden" name="EMAIL" id="EMAIL" class="form-control" value="support@paygate.co.za" />
						</div>
					</div>
					<br>
					<!--<div class="form-group">
...
<!--						<label for="encryption_key" class="col-sm-3 control-label">Encryption Key</label>-->
						<div class="col-sm-6">
							<input type="hidden" name="encryption_key" id="encryption_key" class="form-control" value="secret" />
						</div>
					</div>
					
					<div class="form-group">
						<div class=" col-sm-offset-4 col-sm-4">
							<input type="submit" name="btnSubmit" class="btn btn-success btn-block" value="Yes" />
							<input type="button" name="button" class="btn btn-danger btn-block" value="No" />
						</div>
					</div>
					<br>
				</form>
